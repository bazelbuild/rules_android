    ...
    dict(
        ...
        data = attr.label_list(
            ...
            doc = (
                ...
                "This may include data files or binaries used when this target's srcs are executed. " +
                "See the data dependencies section (https://g3doc.corp.google.com/devtools/blaze/g3doc/build-ref.html#data) " +
                ...
                "Rules' implementation functions must also populate the target's runfiles from the outputs and runfiles of " +
                "any data attribute, as well as runfiles from any dependency attribute which provides either source code or runtime " +
                "dependencies."
            ),
        ),
        plugins = attr.label_list(
            ...
            doc = ("Java compiler plugins to run at compile-time. " +
                   "Every java_plugin specified in the plugins attribute will be run whenever this target is built. " +
                   "Resources generated by the plugin will be included in the result jar of the target."),
        ),
        javacopts = attr.string_list(
            doc = ("Extra compiler options for this target. " +
