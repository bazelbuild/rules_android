...
ATTRS = _attrs.add(
    dict(
        ...
        # Annotations stamped onto the sources generated by the AOSP AIDL
        # compiler, e.g. @android.annotation.Hide.
        _aidl_annotations_lib = attr.label(
            default = Label("//rules:aidl_annotations_lib"),
        ),
    ),
