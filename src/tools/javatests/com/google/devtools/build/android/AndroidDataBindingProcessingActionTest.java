...
public class AndroidDataBindingProcessingActionTest {
  ...
  public void testOneResourceRoot() throws Exception {
    ...
    String resourceRoot =
        testDataPrefix
            + "src/tools/javatests/com/google/devtools/build/android/testing/databinding/res";
  ...
  public void testTwoResourceRoots() throws Exception {
    ...
    String resourceRoot2 =
        testDataPrefix
            + "src/tools/javatests/com/google/devtools/build/android/testing/databinding/res2";
